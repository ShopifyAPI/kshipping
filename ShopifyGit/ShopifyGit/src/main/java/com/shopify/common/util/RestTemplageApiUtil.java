...
public class RestTemplageApiUtil {
	
	RestTemplate restTpl = new RestTemplate();
	
	/**
     * Simple RestTemplate (Get)
     * 
     * @param baseUrl      도메인
	...
	public void sendGet(String baseUrl, int currentPage, int rowsPerPage){
        String reqUrl = baseUrl + "?authKey={authKey}&tPage={currentPage}&rowsPerPage={rowsPerPage}";
	...
	/**
     * Simple RestTemplate (Post) + Headers + Body
     * 
