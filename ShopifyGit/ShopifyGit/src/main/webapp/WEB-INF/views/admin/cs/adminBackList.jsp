...
<script type="text/javascript">
	...
	var bindEvent = function () {
        ...
        $(document).on("click",".list-edit",function(){  
            ...
            /* var masterCode = $(this).closest("tr").data("idx");
            var url = "/admin/cs/popup/adminBackShowPop?masterCode=" + masterCode;
            openPop(url, "", 1200, "", "", ""); */
        });
    ...
    var downExcel = function() {
        location.replace("/admin/cs/adminBackListExcel");
    }
        ...
        <div class="contents">
           <div class="cont_body">
               <article>
                    ...
                    <ul class="tab">
                        <li><a href="/admin/cs/adminDeliveryList"><spring:message code="incgnb.shipment" text="배송" /></a></li>
                        <li><a href="/admin/cs/adminErrorList"><spring:message code="cs.error" text="에러" /></a></li>
                        <li class="on"><a href="/admin/cs/adminBackList"><spring:message code="cs.back" text="반송" /></a></li>
					...
					<ul class="tab_conts">
                        <li>
                            <div class="tit_wrap mt0">
                            	<form name="searchform" method="get" id="searchform" action="/admin/cs/adminBackList">
                            		<div class="sect_right">
	                                    <%-- 상태 변경은 서비스 하지 않고 반송으로만 처리 
                                        <select class="select-ajax" name="searchState"  id="searchState" 
                                                data-codetype="" data-code="${search.searchState}" data-url="/common/componentDataSet" data-param='{ "codeGroup" : "A040000" }'>
                                        </select> 
                                        --%>
	                                    <div  class="month">
                            ...
                            <div class="module_group">
                                <div class="btn_group">
									<%-- <button type="button" class="btn_type2"><spring:message code="cs.sendGuide" text="안내 발송" /></button> --%>
									<%-- <button type="button" class="btn_type2"><spring:message code="cs.exchangeRequest" text="교환신청" /></button> --%>
									<%-- <button type="button" class="btn_type2"><spring:message code="cs.returnRequest" text="반품신청" /></button> --%>
									<%-- <button type="button" class="btn_type2"><spring:message code="cs.cancleRequest" text="취소신청" /></button></button> --%>
                                    <%-- <button type="button" class="btn_type1 down"><span><spring:message code="button.down" text="내려받기" /></button></span></button> --%>
                            ...
                            <table class="tbtype">
                                ...
                                <c:choose>
                                    <c:when test="${fn:length(list) == 0}">
                                        <tr>
                                            <td class="t_center" colspan="9"><spring:message code="settings.nolist" text="등록된 정보가 없습니다." /></td>
                                        </tr>
                                    </c:when>
                                   <c:otherwise>
