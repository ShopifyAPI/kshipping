...
<script type="text/javascript">
    ...
    var downExcel = function() {
        var _url = "/admin/cs/adminErrorListExcel";
           ...
           <div class="cont_body">
               <article>
                    ...
                    <ul class="tab">
                        ...
                        <li class="on"><a href="/admin/cs/adminErrorList"><spring:message code="cs.error" text="에러" /></a></li>
