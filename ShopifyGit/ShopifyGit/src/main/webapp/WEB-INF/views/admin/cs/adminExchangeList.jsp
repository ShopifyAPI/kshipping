...
<script type="text/javascript">
	...
	var bindEvent = function () {
        ...
        $(document).on("click",".list-edit",function(){ 
           ...
           /*  var masterCode = $(this).closest("tr").data("idx");
            var url = "/admin/cs/popup/adminExchangeShowPop?masterCode=" + masterCode;
            openPop(url, "", 1200, "", "", ""); */
        });
    ...
    var downExcel = function() {
    	location.replace("/admin/cs/adminExchangeListExcel");
    }
           ...
           <div class="cont_body">
               <article>
                    ...
                    <ul class="tab">
                        ...
                        <li class="on"><a href="/admin/cs/adminExchangeList"><spring:message code="cs.exchange" text="교환" /></a></li>
					...
					<ul class="tab_conts">
                        <li>
                            <div class="tit_wrap mt0">
                            	<form name="searchform" method="get" id="searchform" action="/admin/cs/adminExchangeList">
                            ...
                            <div class="module_group">
                                <div class="btn_group">
									...
									<%-- <button type="button" id="btn_exchangeProceeding" class="btn_type2"><spring:message code="cs.cs.exchangeProceeding" text="교환처리중" /></button> --%>
									<%-- <button type="button" id="btn_exchangeComplete" class="btn_type2"><spring:message code="cs.exchangeComplete" text="교환완료" /></button> --%>
