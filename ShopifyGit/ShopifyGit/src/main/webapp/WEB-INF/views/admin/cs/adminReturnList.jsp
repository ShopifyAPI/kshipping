...
<script type="text/javascript">
	...
	var bindEvent = function () {
        ...
        $(document).on("click",".list-edit",function(){  
            ...
            /* var masterCode = $(this).closest("tr").data("idx");
            var url = "/admin/cs/popup/adminReturnShowPop?masterCode=" + masterCode;
            openPop(url, "", 1200, "", "", ""); */
        });
    ...
    var downExcel = function() {
    	location.replace("/admin/cs/adminReturnListExcel");
    }
           ...
           <div class="cont_body">
               <article>
                    ...
                    <ul class="tab">
                        ...
                        <li class="on"><a href="/admin/cs/adminReturnList"><spring:message code="cs.return" text="반품" /></a></li>
					...
					<ul class="tab_conts">
                        <li>
                            <div class="tit_wrap mt0">
                            	<form name="searchform" method="get" id="searchform" action="/admin/cs/adminReturnList">
                            		<div class="sect_right">
	                                    <%-- 상태 변경은 서비스 하지 않고 반품으로만 처리 
