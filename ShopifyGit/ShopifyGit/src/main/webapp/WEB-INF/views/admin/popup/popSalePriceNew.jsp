...
**************************************************
 -->
<div class="pop_head">
    <h3><spring:message code="price.popupSalePriceNew" text="할인요금 매핑 등록" />[${zoneCodeId} // ${zoneCodeGroup}]</h3>
    <button type="button" class="btn_close"></button>
</div>

<div class="pop_body">
	<div class="bg_gray wp420">
		<form name="salePrice" id="salePrice" method="post" enctype="multipart/form-data" action="/admin/uploadPriceExcelFile">
		<input type="hidden" value="sale" name="gbn">
		<dl>
    ...
    <div class="pop_btn">
        <button type="button" class="btn_type2" id="btn_write_pop_sale"><span><spring:message code="button.save" text="저장" /></span></button>
    </div>
</div><!--pop_body end-->