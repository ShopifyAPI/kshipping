					...
					<table class="tbtype" border="1">
						...
						<thead> 
							 <tr>
                                            ...
                                            <th><strong><spring:message code="admin.statis.total.subTitle9" text="픽업금액" /></strong></th>
                                            <th><strong><spring:message code="admin.statis.total.subTitle7" text="실배송금액" /></strong></th>
                                            <th><strong><spring:message code="admin.statis.total.subTitle8" text="매입금액" /></strong></th>
                            ...
                            <tr>
                                            ...
                                            <th class="t_right"><p class="total"><fmt:formatNumber value="${sum.sumSalePrice}" pattern="#,###" />&nbsp;</p></th>
                       ...
                       <tbody>
                        	<c:choose>
                        		<c:when test="${fn:length(list) == 0}">
                        			<tr>
                                           <td colspan="14" class="t_center"><p><spring:message code="common.title.notData" text="검색된 데이터가 없습니다." /></p></td>
                                    </tr>
                                </c:when>
                                <c:otherwise>
                                	<c:forEach items="${list}" var="item" varStatus="status">
                                		<tr>
                                            ...
                                            <td class="t_right"><p><fmt:formatNumber value="${item.pickupPrice}" pattern="#,###" /></p></td>
                                            <td class="t_right"><p><strong><fmt:formatNumber value="${item.totalPayment}" pattern="#,###" /></strong></p></td>
                                            <td class="t_right"><p><strong><fmt:formatNumber value="${item.salePrice}" pattern="#,###" /></strong></p></td>
