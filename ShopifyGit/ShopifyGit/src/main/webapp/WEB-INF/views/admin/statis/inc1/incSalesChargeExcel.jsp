...
<head>
    ...
    <title><spring:message code="admin.statis.sales" text="매출 원장(초과)" /></title>
</head>
<body>
	<div class="frame"> <!--프레임 영역 이 div 영역부터 붙여서 넣어주세요.-->
		<div class="frame_wrap">
			...
			<div class="sub_conts">
				...
				<article>
					<div class="tit_wrap">
						<h3><spring:message code="admin.statis.sales.charge" text="초과요금" /></h3>
					</div> <!--tit_wrap end-->
					<table class="tbtype" border="1">
						<colgroup>
							 <col class="wp100">
                                        ...
                                        <col class="wp250"> <!--매출추가요금사유 --> 
                                        <col class="wp250"> <!--매입추가요금사유 -->
                                        <col class="wp100"> <!--매출추가요금 -->
                                        <col class="wp100"> <!--매입추가요금 --> 
                                        <col class="wp100"> <!--부가세 -->
                                        <col class="wp100"> <!--추가요금합계 -->
						</colgroup>
						<thead> 
							 <tr>
                            ...
                            <tr>
                                            ...
                                            <th class="t_right"><p class="total"><fmt:formatNumber value="0" pattern="#,###" />&nbsp;</p></th> <!-- 부가세 -->
                                            <th class="t_right"><p class="total"><fmt:formatNumber value="${sum.sumAddFeesPrice+sum.sumAddSalePrice}" pattern="#,###" />&nbsp;</p></th> <!-- 추가요금합계 -->
                       ...
                       <tbody>
                        	<c:choose>
                        		<c:when test="${fn:length(list) == 0}">
                        			<tr>
                                           <td colspan="15" class="t_center"><p><spring:message code="common.title.notData" text="검색된 데이터가 없습니다." /></p></td>
                                    </tr>
                                </c:when>
                                <c:otherwise>
                                	<c:forEach items="${list}" var="item" varStatus="status">
                                		<tr>
                                            ...
                                            <td class="t_left list-edit"><p>${item.addFeesInfo}</p></td> <!-- 매출추가요금사유 -->
                                            <td class="t_left"><p>${item.addSaleInfo}</p></td> <!-- 매입추가요금사유 -->
                                            ...
                                            <td class="t_right"><p><fmt:formatNumber value="0" pattern="#,###" /></p></td> <!-- 부가세 -->
                                            <td class="t_right"><p><strong><fmt:formatNumber value="${item.addFeesPrice+item.addSalePrice}" pattern="#,###" /></strong></p></td> <!-- 추가요금합계 -->
                                        </tr>
                                   </c:forEach>
                                </c:otherwise>
                            </c:choose>
