...
<script type="text/javascript">
    ...
    var downExcel = function() {
        location.replace("/cs/backListExcel");
    }
    ...
    <div class="frame"> <!--프레임 영역 이 div 영역부터 붙여서 넣어주세요.-->
        ...
        <div class="sub_conts">
                <article>
                    ...
                    <ul class="tab">
                        <li class="on"><a href="/cs/backList"><spring:message code="cs.back" text="반송" /></a></li>
                    ...
                    <ul class="tab_conts">
                        <li>
                            <div class="tit_wrap mt0">
                            	<form name="searchform" method="get" id="searchform" action="/cs/backList">
                            		<div class="sect_right">
	                                    <%-- 
	                                    <select class="select-ajax" name="searchState"  id="searchState" 
		                                		data-codetype="" data-code="${search.searchState}" data-url="/common/componentDataSet" data-param='{ "codeGroup" : "A030000" }'>
	                               		</select> 
	                               		--%>
	                                    ...
	                                    <div class="searchbox"> <!--인풋박스에 클릭시 active 클래스 추가-->
	                                        <input type="text" id="searchWord" name="searchWord" placeholder="<spring:message code="order.seaech.orderWord.label" text="검색어를 입력해주세요." />" value="${search.searchType}">
