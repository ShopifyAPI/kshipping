...
<head>
    ...
    <title><spring:message code="cs.back" text="반송" /></title>
</head>
<body>
    <div class="frame"> <!--프레임 영역 이 div 영역부터 붙여서 넣어주세요.-->
        <div class="frame_wrap">
            ...
            <form name="frm" method="get" id="ajax-form" action="/order">
				...
				<article>
					<div class="tit_wrap">
						<h3><spring:message code="cs.back" text="반송" /></h3>
					</div> <!--tit_wrap end-->
					<table class="tbtype">
	                    <colgroup>
                            <col class="cperauto"/>
...
<%--                                 <th><spring:message code="" text="종류" /></th> --%>
                                ...
                                <th><spring:message code="" text="반송상태" /></th>
