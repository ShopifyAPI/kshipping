...
<script type="text/javascript">
	...
	var bindEvent = function () {
        ...
        //교환처리중
        $(document).on("click","#btn_exchangeProceeding",function(){   
        	var status = "A040030";
        	updateStatus(status);
        });
      
        //교환완료
        $(document).on("click","#btn_exchangeComplete",function(){   
        	var status = "A040040";
        	updateStatus(status);
        });
    ...
    var downExcel = function() {
        location.replace("/cs/exchangeListExcel");
    }
        ...
        <div class="sub_conts">
                <article>
                    ...
                    <ul class="tab">
                        ...
                        <li class="on"><a href="/cs/exchangeList"><spring:message code="cs.exchange" text="교환" /></a></li>
                    ...
                    <ul class="tab_conts">
                        <li>
                            <div class="tit_wrap mt0">
                            	<form name="searchform" method="get" id="searchform" action="/cs/exchangeList">
