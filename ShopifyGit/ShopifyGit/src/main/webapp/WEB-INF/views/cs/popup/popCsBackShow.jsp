...
**************************************************
 -->
				...
				<div class="pop_body">
                    <h4 class="sub_h4 mt10"><spring:message code="admin.order.orderInfo" text="주문/배송정보" /></h4>
                    ...
                    <table class="tbtype2 mt10">
                        ...
                        <tbody>
                        	<tr>
                            	<th><p><spring:message code="order.orderNo" text="주문번호" /></p></th>
                            ...
                            <tr>
                            	<th><p><p><spring:message code="shipment.shipmentCode" text="배송바코드" /></p></th>
                            	<td><p>
                            	<c:if test="${detail.courierCompany == 'B010020' }">${detail.masterCode} </c:if>
                            	<c:if test="${detail.courierCompany == 'B010030' }">${detail.hblNo }</c:if>
                            	</p></td>
                            	<th><p><p><spring:message code="shipment.invoice" text="해외특송번호" /></p></th>
                            	<td><p>
								<c:if test="${detail.courierCompany == 'B010020' }">${detail.masterCode} </c:if>
                            	<c:if test="${detail.courierCompany == 'B010030' }">${detail.hblNo }</c:if>
								</p></td>
                          ...
                          <c:if test="${detail.localCode != ''}">  
                            <tr>
                            	<th><p><p><spring:message code="shipment.localCode" text="국내픽업코드" /></p></th>
                            	<td><p>${detail.localCode}</p></td>
                            	<th><p><p><spring:message code="shipment.localInvoice" text="국내택배번호" /></p></th>
                            	<td><p>${detail.localInvoice}</p></td>
                            </tr>
                          </c:if>  
                            
                            <tr>
                            	<th><p><p><spring:message code="admin.statis.sales.title6" text="배송국가" /></p></th>
                            	<td><p>${detail.buyerCountryCode}</p></td>
                            	<th><p><p><spring:message code="shipment.delivery" text="배송서비스" /></p></th>
                            	<td><p>${detail.courierCode} [${detail.courierCompanyName}]</p></td>
                            </tr>
                            <tr>
                            	<th><p><p><spring:message code="shipment.popup.delivery.price" text="배송비" /></p></th>
                            	<td><p><fmt:formatNumber value="${detail.totalPrice}" pattern="#,###" /></p></td>
                            	<th><p><p><spring:message code="board.status" text="상태" /></p></th>
                            	<td class=""><div class="btn_state ${detail.stateStrCss}">${detail.stateStr}</div></td>
                            </tr>
                            <tr>
                            	<th><p><p><spring:message code="shipment.regDate" text="고객주문일" /></p></th>
                            	<td><p>${detail.orderDate}</p></td>
                            	<th><p><p><spring:message code="shipment.paymentDate" text="배송요청일" /></p></th>
