...
<head>
    ...
    <title><spring:message code="cs.return" text="반품" /></title>
</head>
<body>
    <div class="frame"> <!--프레임 영역 이 div 영역부터 붙여서 넣어주세요.-->
        <div class="frame_wrap">
            ...
            <form name="frm" method="get" id="ajax-form" action="/order">
				...
				<article>
					<div class="tit_wrap">
						<h3><spring:message code="cs.return" text="반품" /></h3>
					</div> <!--tit_wrap end-->
					<table class="tbtype">
	                    <colgroup>
                            <col class="cperauto"/>
...
<%--                                 <th><spring:message code="" text="반품신청" /></th> --%>
<%--                                 <th><spring:message code="" text="반품상태" /></th> --%>
<%--                                 <th><spring:message code="" text="환불상태" /></th> --%>
<%--                                 <th><spring:message code="" text="환불금액" /></th> --%>
                                <th><spring:message code="" text="배송번호" /></th>
                                <th><spring:message code="" text="송장번호" /></th>
<%--                                 <th><spring:message code="" text="원송장번호" /></th> --%>
